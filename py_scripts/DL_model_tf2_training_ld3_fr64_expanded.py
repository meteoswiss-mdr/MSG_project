...
datapath = '/scratch/fvj/dl_data_expanded/'  # Payerne workstation
modelpath = './unet_ld3_fr64_expanded'
callbackpath = './unet_ld3_fr64_expanded_callbacks'
flist_name = 'unet_ld3_fr64_expanded_flist.npz'
hist_name = 'unet_ld3_fr64_expanded_history.pickle'
